...
>
  <div
    class="relative w-full px-6 py-12 bg-white shadow-lg sm:rounded-3xl sm:p-20 bg-clip-padding shadow-slate-700/10 ring-1 ring-gray-900/5 md:max-w-3xl md:mx-auto lg:max-w-4xl lg:pt-16 lg:pb-28 bg-opacity-60 border border-gray-200"
  ...
  >
    ...
    <div class="mt-8 prose prose-zinc mx-auto lg:prose-lg">
      <p class="text-lg text-gray-700">
        This privacy policy applies to [technical savant] and governs the
        collection, use, and disclosure of personal information that may be
        collected anytime you interact with [technical savant], such as when you
        visit our website, use our services, or purchase our products.
      </p>
      <p class="text-lg text-gray-700">
        Please read this privacy policy carefully. By accessing or using
        [technical savant], you acknowledge that you have read, understood, and
        agree to the practices described in this policy. If you do not agree to
        this policy, please do not access or use [technical savant].
      </p>
      ...
      <ul class="text-lg text-gray-700">
        <li>To complete transactions and fulfill your orders</li>
      ...
      <p class="text-lg text-gray-700">
        ...
        transmission is completely secure, and we cannot guarantee the security
      ...
      <p class="text-lg text-gray-700">
        ...
        encourage you to review this policy periodically to stay informed of any
        changes.
      </p>
